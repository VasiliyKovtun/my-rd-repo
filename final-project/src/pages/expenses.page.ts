...
export class ExpensesPage {
    ...
    public readonly expensesTablesComponent: TablesComponent;
    ...
    public constructor(
        ...
        this.expensesTablesComponent = new TablesComponent(this.page.locator('.expenses-table-page'));
        this.tabsComponent = new TabsComponent(this.page.locator('.main-navigation'));
    }

    public async goToExpenses(): Promise<void> {
        await this.page.goto(`${this._url}expenses`);
    }
